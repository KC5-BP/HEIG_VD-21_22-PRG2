...
void exo1(void) {
    ...
    }
    {
        printf("%s", "Exo 1b) -----------------------------\n");
        printf("%#x\n", f(0x1234, 5));
        // Dév. :   0x1234 >> 1 = 0x091a | 0x1234 & 0x0001 => .. | 0x0000 ==> 0x091a
        //          0x091a >> 1 = 0x048d | 0x091a & 0x0001 => .. | 0x0000 ==> 0x048d
        //          0x048d >> 1 = 0x0246 | 0x048d & 0x0001 => .. | 0x8000 ==> 0x8246
        //          0x8246 >> 1 = 0x4123 | 0x8246 & 0x0001 => .. | 0x0000 ==> 0x4123
        //          0x4123 >> 1 = 0x2091 | 0x4123 & 0x0001 => .. | 0x8000 ==> 0xa091
    }
    {
        printf("%s", "Exo 1c) -----------------------------\n");
        int32_t t[][4] = {{1},
